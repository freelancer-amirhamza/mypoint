...
const AdminHeader = ({setActiveSidebar,activeSidebar}) => {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full items-center justify-between shadow-md">
      <div className="bg-secondary relative lg:max-w-60 flex items-center w-full py-10 px-5 gap-2 lg:justify-center h-14">
        ...
        <div className="absolute md:-right-4 right-4 text-amber-500 cursor-pointer text-4xl"
        onClick={()=>setActiveSidebar(!activeSidebar)}
        >
        <LuSquareMenu />
      </div>
      </div>
      <div className="flex py-5 flex-row-reverse gap-x-5 items-center  mx-4 gap-0.5">
